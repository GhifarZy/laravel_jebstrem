                ...
                <div class="col-sm-5">
                    ...
                    <div class="user-area dropdown float-right">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <div class="font-medium text-base text-gray-800" style="color:black;margin: 6px;" >{{ Auth::user()->name }}</div>
                        </a>

                        <div class="user-menu dropdown-menu" style="background-color:#f1f2f7;">
